...
void mt6639_dumpPcieReg(void)
{
	...
	/* MAC */
	connv3_hif_dbg_write(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030168, 0x3000100);
	connv3_hif_dbg_write(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030164, 0xA070000);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x7403002C, &u4Value);
	DBGLOG(HAL, INFO, "CR[0x7403002C] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_write(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030168, 0xcccc0100);
	connv3_hif_dbg_write(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74030164, 0x45474849);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x7403002C, &u4Value);
	DBGLOG(HAL, INFO, "CR[0x7403002C] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_write(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
	...
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74031224, &u4Value);
	DBGLOG(HAL, INFO, "CR[0x74031224] value[0x%08x]\n", u4Value);
	connv3_hif_dbg_read(CONNV3_DRV_TYPE_WIFI, CONNV3_DRV_TYPE_BT,
		0x74031228, &u4Value);
	DBGLOG(HAL, INFO, "CR[0x74031228] value[0x%08x]\n", u4Value);
