...
enum {
	REVERSE_TEMP_RANGE_INIT = 0,
	REVERSE_TEMP_RANGE_COLD,
	REVERSE_TEMP_RANGE_COOL, /* 0 ~ 16 */
	REVERSE_TEMP_RANGE_NORMAL, /* 16 ~ 45 */
	REVERSE_TEMP_RANGE_WARM, /* 45-52 */
	REVERSE_TEMP_RANGE_HIGH,
};
enum {
