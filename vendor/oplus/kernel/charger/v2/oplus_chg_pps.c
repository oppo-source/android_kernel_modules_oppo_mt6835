...
#define OPLUS_PPS_OK_CURRENT_DEBOUNCE (100)
...
#define OPLUS_PPS_ABNORMAL_CURR (100)
	...
	curr_ok_thd = chip->target_curr_ma * curr_ratio - OPLUS_PPS_OK_CURRENT_DEBOUNCE;
	curr_high_thd = chip->target_curr_ma * curr_ratio + OPLUS_PPS_OK_CURRENT_DEBOUNCE;
